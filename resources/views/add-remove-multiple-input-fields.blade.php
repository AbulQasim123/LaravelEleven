...
<head>
    <title>Laravel 10 - Add/remove multiple input fields dynamically using Jquery</title>
    ...
    <div class="container">
        <div class="card mt-3">
            <div class="card-header">
                <h2>Add/remove Multiple Input Todo Fields Dynamically using Jquery In Laravel 10</h2>
            </div>
            <div class="card-body">
                <form action="{{ url('add-remove-multiple-input-fields') }}" method="POST">
                    ...
                    <table class="table table-bordered" id="dynamicAddRemove">
                        ...
                        <tr>
                            <td>
                                <input type="text" name="moreFields[0][title]" placeholder="Enter title"
                                    class="form-control" />
                            </td>
                            <td>
