...
<head>
    ...
    <title>Laravel 11 Ajax CRUD Image Upload Tutorial</title>
...
<body>
    <div class="container" style="margin-top: 1%;">
        <h1>Laravel Ajax CRUD Image Upload Tutorial</h1>
        <a href="javascript:void(0)" class="btn btn-outline-info btn-sm ml-3" id="create-new-task">Add New</a>
        <br><br>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="taskCrudModal">Add New Task</h4>
                    <button type="button" class="close" aria-hidden="true" data-bs-dismiss="modal" aria-label="Close">
                ...
                <div class="modal-body">
                    <form id="taskForm" name="taskForm" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <img id="modal-preview" src="https://via.placeholder.com/150" alt="Preview"
                            class="form-group mt-2 hidden" width="100" height="100">
