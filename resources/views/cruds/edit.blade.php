    ...
    <div class="container mt-2">
        <div class="row">
            <div class="col-lg-12 margin-tb">
                <div class="pull-left">
                    <h2>Laravel 11 Image Upload with CRUD Operation Example Tutorial</h2>
                </div>
                <div class="pull-left">
                    <h2>Edit vacancy
                    </h2>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="description"
                            value="{{ $vacancy->description }}" class="form-control"
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <br>
                        <img src="{{ asset('storage/images/' . $vacancy->image) }}" alt="Your Image" width="100px"
                            height="100px">
                        @error('image')
                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
